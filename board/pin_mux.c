...
pin_labels:
- {pin_num: '20', pin_signal: PIO0_24, label: RXD0, identifier: RXD0}
- {pin_num: '19', pin_signal: PIO0_25, label: TXD0, identifier: TXD0}
...
void UART0_Pins(void)
{
    ...
    const uint32_t RXD0 = (/* Selects pull-up function */
    ...
    IOCON_PinMuxSet(IOCON, IOCON_INDEX_PIO0_24, RXD0);

    const uint32_t TXD0 = (/* Selects pull-up function */
                           IOCON_PIO_MODE_PULLUP |
                           /* Enable hysteresis */
                           IOCON_PIO_HYS_EN |
                           /* Input not invert */
    ...
    IOCON_PinMuxSet(IOCON, IOCON_INDEX_PIO0_25, TXD0);
